...
create index if not exists idx_sales_units_name ON sales_units(name);
create index if not exists idx_sales_units_sales_category_id ON sales_units(sales_category_id);
create index if not exists idx_sales_units_created_by ON sales_units(created_by);
create index if not exists idx_sales_units_updated_by ON sales_units(updated_by);
