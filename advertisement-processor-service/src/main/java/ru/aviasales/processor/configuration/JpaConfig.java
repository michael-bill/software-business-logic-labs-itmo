...
public class JpaConfig {
    ...
    public DataSource dataSource() {
        ...
        pgxaDataSource.setUrl(environment.getProperty("spring.jta.atomikos.datasource.advertisement-processor-xa-ds.xa-properties.url"));
        pgxaDataSource.setUser(environment.getProperty("spring.jta.atomikos.datasource.advertisement-processor-xa-ds.xa-properties.user"));
        pgxaDataSource.setPassword(environment.getProperty("spring.jta.atomikos.datasource.advertisement-processor-xa-ds.xa-properties.password"));
